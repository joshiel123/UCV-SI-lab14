"""
dataset.py
Centraliza los datos de entrada del sistema.
Permite escalar el proyecto con nuevos estudiantes o fuentes de datos.
"""


# Dataset principal usado en el laboratorio
ESTUDIANTES = [
